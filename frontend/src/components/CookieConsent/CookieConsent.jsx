  ...
  return (
    <div className="cookie-consent">
      <div className="cookie-consent__content">
        ...
        <p className="cookie-consent__title">Cookie & Cache</p>

        <p className="cookie-consent__description">
          Мы обрабатываем ваши персональные данные для измерения и улучшения наших сайтов и сервисов, помощи в кампаниях и предоставления персонализированного контента.
          <br />
          <Link to='/privacy-policy' className="cookie-consent__privacy-link">
        ...
        <button
          type="button"
          className="cookie-consent__more-options"
        >
        </button>
        <div></div>
        <button
